defmodule QcommerceWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(QcommerceWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(QcommerceWeb.Gettext, "errors", msg, opts)
    end
  end
