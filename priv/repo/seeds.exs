...
# Safe to re-run — all inserts use on_conflict: :nothing
...
IO.puts("🌱 Seeding QCommerce database...")
...
# =============================================================================
# CATEGORIES
# — our Category schema only has: name, slug, sort_order, is_active, parent_id
# — emoji is NOT a DB column; we display emoji from the seed name in the UI
# =============================================================================

cats_data = [
  %{name: "Vegetables", slug: "vegetables", sort_order: 0},
  %{name: "Fruits", slug: "fruits", sort_order: 1},
  %{name: "Dairy & Eggs", slug: "dairy-eggs", sort_order: 2},
  ...
  %{name: "Beauty", slug: "beauty", sort_order: 7},
  %{name: "Cleaning", slug: "cleaning", sort_order: 8},
  %{name: "Baby", slug: "baby", sort_order: 9},
  %{name: "Pet Care", slug: "pet-care", sort_order: 10},
  %{name: "Frozen", slug: "frozen", sort_order: 11},
  %{name: "Breakfast", slug: "breakfast", sort_order: 12},
  %{name: "Organic", slug: "organic", sort_order: 13},
  %{name: "Health", slug: "health", sort_order: 14}
]

# Build slug → category map, upsert each
cats =
...
# =============================================================================
# PRODUCTS
# Field mapping to our Product schema:
#   name, sku, base_price (Decimal), old_price (Decimal|nil),
#   unit, emoji, description, is_active, category_id
# =============================================================================
...
# Insert all products, upsert by SKU
prods =
...
# =============================================================================
# SLIDES
# Each slide links to products via the slide_products join table.
# We use Repo.insert_all on "slide_products" directly — no position column.
# =============================================================================
...
Enum.each(slides_data, fn data ->
  # Skip if slide already exists for this position
